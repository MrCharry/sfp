...
class Agent(nn.Module):
    ...
    def _getPreClsIndexes(self, outputs, labels):
    ...
    def trainOn(self, X_trainset, y_trainset, batch_size=config.BATCH_SIZE):
        ...
        for epoch in range(config.EPOCHS):
            ...
            print('Epoch: ', epoch, 'Batch No:  ', m, 'Train loss: ', train_loss/m,
        ...
        with torch.no_grad():
            ...
            for X_tests, y_tests in zip(X_testset, y_testset):
                ...
                for X_test, y_test in test_iter:
                    ...
                    predicted.append(self._getPreClsIndexes(outputs, y_test).numpy())
